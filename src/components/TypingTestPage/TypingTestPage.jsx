                ...
                <article>
                  ...
                  <ul className="list-decimal list-outside text-base pl-5 mobile:text-sm xs:text-[13px]">
                    <li className="mb-1">
                      ...
                      and the Words per minute (WPM) will be calculated
                      according to the number of words typed by you within the
                      given time slot. While giving test in this mode, you have
                      to select the time slot given on test page or by default
                      1min time slot will be selected.
                    </li>
                    <li>
                      In word mode, you have to select the number of words you
                      want to type and the WPM will be calculated by the time
                      taken by you to type the given words or by default, 20
